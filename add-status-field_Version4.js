...
const GH_TOKEN = process.env.GH_TOKEN; // Set this in your GitHub Action secrets
const PROJECT_ID = process.env.PROJECT_ID; // Set this to your project ID
...
// Helper to call GitHub GraphQL API
